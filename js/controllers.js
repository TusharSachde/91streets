...
.controller('DiscountCtrl', function ($scope, $cordovaGeolocation, $stateParams, $ionicPopup, MyServices, $ionicModal) {
    ...
    $scope.hideSort = function (dep) {
        ...
        $scope.oModal3.hide();
        $scope.checkval = 2;
        MyServices.getcatarraystoreoffer($scope.catarray, 0).success(getdiscount);
    };
    ...
    $scope.loadMore = function () {
        ...
        if (lastlength != totallength) {
            ...
            if ($scope.checkval == 2) {
                MyServices.getcatarraystoreoffer($scope.catarray, totallength).success(pushgetdiscount);
            }
